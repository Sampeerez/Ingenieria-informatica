...
int main()
{
  ...
  std::cout << "\nModificación, introducir coeficiente y eliminar monomio con dicho coeficiente (sllp3 con el valor -8.9):" << std::endl;
  std::cout << sllp3.EliminarMonomioCoeficiente(-8.9) << std::endl;
